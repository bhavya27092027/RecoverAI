...
- **Instant Failure Ingestion & Classification:** Captures failure events in real-time and categorizes drops across 6 distinct failure categories: `BANK_TIMEOUT`, `INSUFFICIENT_BALANCE`, `CARD_DECLINED`, `AUTHENTICATION_FAILURE`, `TRANSACTION_LIMIT`, and `CUSTOMER_ABANDONMENT`.
